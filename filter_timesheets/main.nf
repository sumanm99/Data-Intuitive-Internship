...
meta = [
    ...
    "resources" : [
      {
        ...
        "is_executable" : true,
        "parent" : "file:/mnt/d/Data_Intuitive_Internship/GitHub/filter_timesheets/"
      }
    ],
  ...
  "info" : {
    "config" : "/mnt/d/Data_Intuitive_Internship/GitHub/filter_timesheets/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "target/nextflow/filter_timesheets",
    "viash_version" : "0.8.6",
...
par = {
  ...
  'year': $( if [ ! -z ${VIASH_PAR_YEAR+x} ]; then echo "int(r'${VIASH_PAR_YEAR//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_duration_per_project': $( if [ ! -z ${VIASH_PAR_MIN_DURATION_PER_PROJECT+x} ]; then echo "int(r'${VIASH_PAR_MIN_DURATION_PER_PROJECT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
